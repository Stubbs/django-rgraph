    ...
    RGraph.Waterfall.prototype.Draw = function ()
    {
        ...
        */
        ...
        for (var i=0; i<this.data.length; ++i) {
            ...
            this.max = Math.max(this.max, Math.abs(runningTotal));
        }
        ...
        */
        if (this.Get('chart.labels').length > 0) {
            ...
            for (var i=0; i<labels.length; ++i) {
                ...
                RGraph.Text(context,font,size,this.gutterLeft - 5 + (i * interval) + (interval / 2),RGraph.GetHeight(this) - this.gutterBottom + 5 + this.halfTextHeight, labels[i],'center',halign,null,angle);
        ...
        var runningTotal = 0;
            ...
            for (var i=0; i<this.data.length; ++i) {
                ...
                context.strokeStyle = this.Get('chart.strokestyle');
                    ...
                    var x      = this.gutterLeft + hmargin + ((this.graphwidth / (this.data.length + (this.Get('chart.total') ? 1 : 0))) * i);
